...
class _AddCharityNeedSheetState extends State<AddCharityNeedSheet> {
  ...
  void _submit(BuildContext context) {
    ...
    context.read<AddPostCubit>().createCharityNeed(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: isLoading || state is AddPostSuccess
                                ? null
                                : () => _submit(context),
                            style: ElevatedButton.styleFrom(
                              backgroundColor: state is AddPostSuccess
                                  ? Colors.green.shade600
                                  : const Color(0xFF1D9E75),
                              disabledBackgroundColor: state is AddPostSuccess
                                  ? Colors.green.shade600
                                  : null,
